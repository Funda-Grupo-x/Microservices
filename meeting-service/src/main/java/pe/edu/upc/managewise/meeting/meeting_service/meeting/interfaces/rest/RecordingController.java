package pe.edu.upc.managewise.meeting.meeting_service.meeting.interfaces.rest;


import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.domain.model.RecordingDTO;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.domain.model.aggregates.Meeting;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.domain.model.commands.CreateRecordingCommand;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.domain.model.commands.DeleteRecordingCommand;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.domain.model.queries.GetMeetingByIdQuery;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.domain.model.queries.GetMeetingByTitleQuery;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.domain.services.MeetingQueryService;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.domain.services.RecordingCommandService;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.domain.services.RecordingService;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.interfaces.rest.transform.RecordingTransformer;
