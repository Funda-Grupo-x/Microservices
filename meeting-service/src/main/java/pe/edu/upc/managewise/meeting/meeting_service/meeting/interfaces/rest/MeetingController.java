...
import pe.edu.upc.managewise.meeting.meeting_service.meeting.domain.model.commands.DeleteMeetingCommand;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.domain.model.queries.GetAllMeetingsQuery;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.domain.model.queries.GetMeetingByIdQuery;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.domain.services.MeetingCommandService;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.domain.services.MeetingQueryService;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.interfaces.rest.resources.CreateMeetingResource;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.interfaces.rest.resources.MeetingResource;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.interfaces.rest.transform.CreateMeetingCommandFromResourceAssembler;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.interfaces.rest.transform.MeetingResourceFromEntityAssembler;
import pe.edu.upc.managewise.meeting.meeting_service.meeting.interfaces.rest.transform.UpdateMeetingCommandFromResourceAssembler;
