package pe.edu.upc.managewise.issueservice.issues.interfaces.rest;
...
import pe.edu.upc.managewise.issueservice.issues.domain.model.commands.CreateEventByIssueIdCommand;
import pe.edu.upc.managewise.issueservice.issues.domain.model.commands.CreateEventResource;
import pe.edu.upc.managewise.issueservice.issues.domain.model.commands.DeleteIssueCommand;
import pe.edu.upc.managewise.issueservice.issues.domain.model.queries.GetAllIssuesQuery;
import pe.edu.upc.managewise.issueservice.issues.domain.model.queries.GetIssueByIdQuery;
import pe.edu.upc.managewise.issueservice.issues.domain.services.IssueCommandService;
import pe.edu.upc.managewise.issueservice.issues.domain.services.IssueQueryService;
import pe.edu.upc.managewise.issueservice.issues.interfaces.rest.resources.CreateIssueResource;
...
import pe.edu.upc.managewise.issueservice.issues.interfaces.rest.transform.CreateIssueCommandFromResourceAssembler;
import pe.edu.upc.managewise.issueservice.issues.interfaces.rest.transform.EventRecordItemResourceFromEntityAssembler;
import pe.edu.upc.managewise.issueservice.issues.interfaces.rest.transform.IssueResourceFromEntityAssembler;
import pe.edu.upc.managewise.issueservice.issues.interfaces.rest.transform.UpdateIssueCommandFromResourceAssembler;
